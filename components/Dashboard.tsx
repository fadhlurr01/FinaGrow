...
const Dashboard: React.FC = () => {
  ...
  const effectiveWatchlist = useMemo(() => {
    ...
    if (isDemo) {
      return [
        { id: 'w-1', code: '1002', name: 'Bank BCA Priority (IDR)', type: 'ASSET', currentBalance: 1250000000 },
        { id: 'w-2', code: '1003', name: 'Bank Mandiri Corporate (IDR)', type: 'ASSET', currentBalance: 680000000 },
        { id: 'w-3', code: '1100', name: 'Piutang Usaha (AR)', type: 'ASSET', currentBalance: 799200000 },
        { id: 'w-4', code: '2000', name: 'Utang Usaha (AP)', type: 'LIABILITY', currentBalance: 105450000 },
      ];
    }
    return [];
  }, [summary, isDemo]);
      ...
      return [
        {
          id: 'tx-1',
          date: '2026-08-29',
          description: 'Pelunasan Tagihan AWS Cloud Infrastructure',
        ...
        },
        {
          id: 'tx-2',
          date: '2026-08-26',
          description: 'Pembayaran Termin 1 Kemenkeu RI',
        ...
        },
        {
          id: 'tx-3',
          date: '2026-08-21',
          description: 'Pembayaran Lisensi PT Astra International',
          type: 'income' as const,
