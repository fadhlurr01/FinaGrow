      ...
      return [
        {
          ...
          status: 'ON_TRACK',
          accountCode: '6001',
          accountName: 'Beban Gaji & Tunjangan Staf',
          account: { code: '6001', name: 'Beban Gaji & Tunjangan Staf', type: 'EXPENSE' },
          notes: 'Alokasi penggajian seluruh tim Q3',
        },
        {
          id: 'bg-2',
          entityId: activeEntityId || 'e-bc',
          ...
          period: selectedPeriod,
          amount: 120000000,
          actualSpent: 95000000,
          remaining: 25000000,
          utilization: 79.2,
          status: 'ON_TRACK',
          accountCode: '6002',
          accountName: 'Beban Cloud Server & Hosting',
          account: { code: '6002', name: 'Beban Cloud Server & Hosting', type: 'EXPENSE' },
          notes: 'Infrastruktur AWS & Cloudflare',
        },
        {
          id: 'bg-3',
          entityId: activeEntityId || 'e-bc',
          ...
          period: selectedPeriod,
          amount: 50000000,
          actualSpent: 45000000,
          remaining: 5000000,
          utilization: 90,
          status: 'ON_TRACK',
          accountCode: '6003',
          accountName: 'Beban Pemasaran Digital & Ads',
          account: { code: '6003', name: 'Beban Pemasaran Digital & Ads', type: 'EXPENSE' },
          notes: 'Kampanye Q3 LinkedIn & Meta Ads',
        },
        {
          id: 'bg-4',
          entityId: activeEntityId || 'e-bc',
          ...
          account: { code: '5001', name: 'Harga Pokok Penjualan (HPP)', type: 'EXPENSE' },
          notes: 'Biaya langsung pengadaan software & lisensi',
        },
      ] as any[];
    }
    return [];
